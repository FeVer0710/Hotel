...
<head>
    ...
    <title> FORMULARIO MATRIMONIAL </title>
    <!--Codigo de Bootstrap-->
    ...
    <div class="modal-dialog text-center">
        <div class="col-sm-12 main-section text-white">
            <div class="modal-content">
                <div class="col-12 icono-formulario-matrimonial">
                    <img src="imagenes/Matrimonial.jpg" width="50%">
                    <p class="mt-4">¡Capacidad para dos personas!
                ...
                <form action="" class="col-12">
                    ...
                    <div class="form-group" id="nombre-matrimonial">
                        <input type="text" class="form-group" name="nombre" placeholder="Nombre">
                    </div>

                    <div class="form-group" id="apellido-matrimonial">
                        <input type="text" class="form-group" name="apellido" placeholder="Apellido">
                    </div>

                    <div class="form-group" id="numero-matrimonial">
                        <input type="text" class="form-group" name="numero" maxlength="8" placeholder="Número telefónico">
                    </div>

                    <div class="form-group" id="direccion-matrimonial">
                        <input type="text" class="form-group" name="direccion" placeholder="Dirección">
                    </div>

                    <div class="form-group" id="acompanante-matrimonial">
                        <input type="text" class="form-group" name="acompanante" placeholder="Nombre acompañante">
                    </div>

                    <div class="form-group" id="apellido-acompanante-matrimonial">
