...
<head>
    ...
    <title> FORMULARIO CLÁSICA </title>
    <!--Codigo de Bootstrap-->
    ...
    <div class="modal-dialog text-center">
        <div class="col-sm-12 main-section text-white">
            <div class="modal-content">
                <div class="col-12 icono-formulario-clasica">
                    <img src="imagenes/Clásica.jpg" width="50%">
